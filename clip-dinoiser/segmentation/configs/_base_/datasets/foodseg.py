...
dataset_type = 'FoodSegDataset'
data_root = '/home/ulindu/datasets/FoodSeg103'
img_scale = (640, 640)
crop_size = (128, 128)
train_pipeline = [
...
data = dict(
    train=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir="Images/img_dir/train",
        ann_dir="Images/ann_dir/train",
        pipeline=train_pipeline,
    ),
    test=dict(
        type=dataset_type,
        data_root=data_root,
        img_dir="Images/img_dir/test",
        ann_dir="Images/ann_dir/test",
